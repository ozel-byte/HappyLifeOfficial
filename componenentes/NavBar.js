            ...
            <>
                <header className="header">
                    <div className="logo-container">
                        <img src="../imgs/logo3.png" alt="" width="40px" height="40px"/>
                        <h2>HappyLife</h2>
                    </div>
                    <nav>
                ...
                <div className="row">
                    ...
                    <div className="col-12 d-flex justify-content-center p-1">
                        <p>Attract real and relevant followers to grow your Instagram audience.<br/>
                            Get more Instagram followers, likes, comments, traffic & leads.</p>
                    </div>
                ...
                <div className="pl-5 pt-2 d-flex align-items-center justify-content-center pr-5">
                    <img src="https://cdn.dribbble.com/users/2155177/screenshots/14712406/media/6bcacf899d6346d8420cd18ad5be79dc.png?compress=1&resize=800x600" alt="fondo" width="550px" height="400px"/>
                  <div className="letra-presentacion2">
                      <h3>
                          Las personas nacidas entre<br/> los años 2000 a 2005
                      </h3>
                      <p>
                          Las personas nacidas entre los años 2000 a 2005<br/>
                ...
                <div className="pl-5 pt-2 d-flex align-items-center justify-content-center pr-5 pt-4">
                    <div className="letra-presentacion2 pl-5">
                        <h3>
                            Get real Instagram<br/>followers faster
                        </h3>
                        <p>
                            Our Instagram growth service helps you attract<br/>
                            new followers who are interested in your content.<br/>
                            Grow your audience, expand your reach, raise <br/>
                            awareness & build your brand — in any sector.<br/>
                        </p>
                    </div>
                    <div className="">
